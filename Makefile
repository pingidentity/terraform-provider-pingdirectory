...
# Start a PingDirectory instance locally to test against
	docker run --name pingdirectory_terraform_provider_container \
		...
		pingidentity/pingdirectory:$${PINGDIRECTORY_PROVIDER_PRODUCT_VERSION:-10.3.0.0}-latest
...
testacc:
	...
	PINGDIRECTORY_PROVIDER_PRODUCT_VERSION=$${PINGDIRECTORY_PROVIDER_PRODUCT_VERSION:-10.3.0.0} \
