...
# Use "pingdirectory_default_groovy_scripted_file_based_access_log_publisher" if you are adopting existing configuration from the PingDirectory server into Terraform
