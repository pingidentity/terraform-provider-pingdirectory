...
var (
	_ resource.Resource                = &thirdPartyAccessLogPublisherResource{}
	_ resource.ResourceWithConfigure   = &thirdPartyAccessLogPublisherResource{}
	_ resource.ResourceWithImportState = &thirdPartyAccessLogPublisherResource{}
	_ resource.Resource                = &defaultThirdPartyAccessLogPublisherResource{}
	_ resource.ResourceWithConfigure   = &defaultThirdPartyAccessLogPublisherResource{}
	_ resource.ResourceWithImportState = &defaultThirdPartyAccessLogPublisherResource{}
)

// Create a Third Party Access Log Publisher resource
func NewThirdPartyAccessLogPublisherResource() resource.Resource {
	return &thirdPartyAccessLogPublisherResource{}
}

func NewDefaultThirdPartyAccessLogPublisherResource() resource.Resource {
	return &defaultThirdPartyAccessLogPublisherResource{}
}

// thirdPartyAccessLogPublisherResource is the resource implementation.
type thirdPartyAccessLogPublisherResource struct {
	providerConfig internaltypes.ProviderConfiguration
	apiClient      *client.APIClient
}

// defaultThirdPartyAccessLogPublisherResource is the resource implementation.
type defaultThirdPartyAccessLogPublisherResource struct {
	providerConfig internaltypes.ProviderConfiguration
	apiClient      *client.APIClient
}

// Metadata returns the resource type name.
func (r *thirdPartyAccessLogPublisherResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_third_party_access_log_publisher"
}

func (r *defaultThirdPartyAccessLogPublisherResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_default_third_party_access_log_publisher"
}

// Configure adds the provider configured client to the resource.
func (r *thirdPartyAccessLogPublisherResource) Configure(_ context.Context, req resource.ConfigureRequest, _ *resource.ConfigureResponse) {
...
func (r *defaultThirdPartyAccessLogPublisherResource) Configure(_ context.Context, req resource.ConfigureRequest, _ *resource.ConfigureResponse) {
	if req.ProviderData == nil {
		return
	}
...
type thirdPartyAccessLogPublisherResourceModel struct {
...
func (r *thirdPartyAccessLogPublisherResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	thirdPartyAccessLogPublisherSchema(ctx, req, resp, false)
}

func (r *defaultThirdPartyAccessLogPublisherResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	thirdPartyAccessLogPublisherSchema(ctx, req, resp, true)
}

func thirdPartyAccessLogPublisherSchema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse, setOptionalToComputed bool) {
	schema := schema.Schema{
		Description: "Manages a Third Party Access Log Publisher.",
...
func addOptionalThirdPartyAccessLogPublisherFields(ctx context.Context, addRequest *client.AddThirdPartyAccessLogPublisherRequest, plan thirdPartyAccessLogPublisherResourceModel) error {
...
func readThirdPartyAccessLogPublisherResponse(ctx context.Context, r *client.ThirdPartyAccessLogPublisherResponse, state *thirdPartyAccessLogPublisherResourceModel, expectedValues *thirdPartyAccessLogPublisherResourceModel, diagnostics *diag.Diagnostics) {
...
func createThirdPartyAccessLogPublisherOperations(plan thirdPartyAccessLogPublisherResourceModel, state thirdPartyAccessLogPublisherResourceModel) []client.Operation {
...
func (r *thirdPartyAccessLogPublisherResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	// Retrieve values from plan
	var plan thirdPartyAccessLogPublisherResourceModel
	...
	if err != nil {
		resp.Diagnostics.AddError("Failed to add optional properties to add request for Third Party Access Log Publisher", err.Error())
		return
	}
	// Log request JSON
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while creating the Third Party Access Log Publisher", err, httpResp)
		return
	}
	...
	var state thirdPartyAccessLogPublisherResourceModel
...
func (r *defaultThirdPartyAccessLogPublisherResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	// Retrieve values from plan
	var plan thirdPartyAccessLogPublisherResourceModel
	diags := req.Plan.Get(ctx, &plan)
	resp.Diagnostics.Append(diags...)
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while getting the Third Party Access Log Publisher", err, httpResp)
		return
	}
	...
	ops := createThirdPartyAccessLogPublisherOperations(plan, state)
	if len(ops) > 0 {
		...
		if err != nil {
			config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while updating the Third Party Access Log Publisher", err, httpResp)
			return
		}
...
func (r *thirdPartyAccessLogPublisherResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	readThirdPartyAccessLogPublisher(ctx, req, resp, r.apiClient, r.providerConfig)
}

func (r *defaultThirdPartyAccessLogPublisherResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	readThirdPartyAccessLogPublisher(ctx, req, resp, r.apiClient, r.providerConfig)
}

func readThirdPartyAccessLogPublisher(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse, apiClient *client.APIClient, providerConfig internaltypes.ProviderConfiguration) {
	// Get current state
	var state thirdPartyAccessLogPublisherResourceModel
...
// Update a resource
func (r *thirdPartyAccessLogPublisherResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	updateThirdPartyAccessLogPublisher(ctx, req, resp, r.apiClient, r.providerConfig)
}

func (r *defaultThirdPartyAccessLogPublisherResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	updateThirdPartyAccessLogPublisher(ctx, req, resp, r.apiClient, r.providerConfig)
}

func updateThirdPartyAccessLogPublisher(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse, apiClient *client.APIClient, providerConfig internaltypes.ProviderConfiguration) {
	// Retrieve values from plan
	var plan thirdPartyAccessLogPublisherResourceModel
	diags := req.Plan.Get(ctx, &plan)
	resp.Diagnostics.Append(diags...)
...
func (r *defaultThirdPartyAccessLogPublisherResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	// No implementation necessary
}

func (r *thirdPartyAccessLogPublisherResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while deleting the Third Party Access Log Publisher", err, httpResp)
		return
	}
}

func (r *thirdPartyAccessLogPublisherResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	importThirdPartyAccessLogPublisher(ctx, req, resp)
}

func (r *defaultThirdPartyAccessLogPublisherResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	importThirdPartyAccessLogPublisher(ctx, req, resp)
}

func importThirdPartyAccessLogPublisher(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
