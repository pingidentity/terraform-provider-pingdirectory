	...
	schemaDef := schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"script_class": schema.StringAttribute{
				Description: " When the `type` value is one of [`groovy-scripted-file-based-access`]: The fully-qualified name of the Groovy class providing the logic for the Groovy Scripted File Based Access Log Publisher. When the `type` value is one of [`groovy-scripted-file-based-error`]: The fully-qualified name of the Groovy class providing the logic for the Groovy Scripted File Based Error Log Publisher. When the `type` value is one of [`groovy-scripted-access`]: The fully-qualified name of the Groovy class providing the logic for the Groovy Scripted Access Log Publisher. When the `type` value is one of [`groovy-scripted-error`]: The fully-qualified name of the Groovy class providing the logic for the Groovy Scripted Error Log Publisher. When the `type` value is one of [`groovy-scripted-http-operation`]: The fully-qualified name of the Groovy class providing the logic for the Groovy Scripted HTTP Operation Log Publisher.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			...
			"output_location": schema.StringAttribute{
				Description: " When the `type` value is one of [`console-json-error`]: Specifies the output stream to which JSON-formatted error log messages should be written. When the `type` value is one of [`console-json-audit`]: Specifies the output stream to which JSON-formatted audit log messages should be written. When the `type` value is one of [`console-json-http-operation`]: Specifies the output stream to which JSON-formatted HTTP operation log messages should be written. When the `type` value is one of [`console-json-access`]: Specifies the output stream to which JSON-formatted access log messages should be written.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			"log_file": schema.StringAttribute{
				Description: " When the `type` value is one of [`third-party-file-based-access`]: The file name to use for the log files generated by the Third Party File Based Access Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`operation-timing-access`]: The file name to use for the log files generated by the Operation Timing Access Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`file-based-trace`]: The file name to use for the log files generated by the File Based Trace Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`common-log-file-http-operation`]: The file name to use for the log files generated by the Common Log File HTTP Operation Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`file-based-json-audit`]: The file name to use for the log files generated by the File Based JSON Audit Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`file-based-debug`]: The file name to use for the log files generated by the File Based Debug Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`file-based-error`]: The file name to use for the log files generated by the File Based Error Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`detailed-http-operation`]: The file name to use for the log files generated by the Detailed HTTP Operation Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`json-access`]: The file name to use for the log files generated by the JSON Access Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`debug-access`]: The file name to use for the log files generated by the Debug Access Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`file-based-audit`]: The file name to use for the log files generated by the File Based Audit Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`json-error`]: The file name to use for the log files generated by the JSON Error Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`groovy-scripted-file-based-access`]: The file name to use for the log files generated by the Scripted File Based Access Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`groovy-scripted-file-based-error`]: The file name to use for the log files generated by the Scripted File Based Error Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`third-party-file-based-error`]: The file name to use for the log files generated by the Third Party File Based Error Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`file-based-access`]: The file name to use for the log files generated by the File Based Access Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. When the `type` value is one of [`file-based-json-http-operation`]: The file name to use for the log files generated by the File Based JSON HTTP Operation Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			"log_file_permissions": schema.StringAttribute{
				Description: " When the `type` value is one of [`third-party-file-based-access`]: The UNIX permissions of the log files created by this Third Party File Based Access Log Publisher. When the `type` value is one of [`operation-timing-access`]: The UNIX permissions of the log files created by this Operation Timing Access Log Publisher. When the `type` value is one of [`file-based-trace`]: The UNIX permissions of the log files created by this File Based Trace Log Publisher. When the `type` value is one of [`common-log-file-http-operation`]: The UNIX permissions of the log files created by this Common Log File HTTP Operation Log Publisher. When the `type` value is one of [`file-based-json-audit`]: The UNIX permissions of the log files created by this File Based JSON Audit Log Publisher. When the `type` value is one of [`file-based-debug`]: The UNIX permissions of the log files created by this File Based Debug Log Publisher. When the `type` value is one of [`file-based-error`]: The UNIX permissions of the log files created by this File Based Error Log Publisher. When the `type` value is one of [`detailed-http-operation`]: The UNIX permissions of the log files created by this Detailed HTTP Operation Log Publisher. When the `type` value is one of [`json-access`]: The UNIX permissions of the log files created by this JSON Access Log Publisher. When the `type` value is one of [`debug-access`]: The UNIX permissions of the log files created by this Debug Access Log Publisher. When the `type` value is one of [`file-based-audit`]: The UNIX permissions of the log files created by this File Based Audit Log Publisher. When the `type` value is one of [`json-error`]: The UNIX permissions of the log files created by this JSON Error Log Publisher. When the `type` value is one of [`groovy-scripted-file-based-access`]: The UNIX permissions of the log files created by this Scripted File Based Access Log Publisher. When the `type` value is one of [`groovy-scripted-file-based-error`]: The UNIX permissions of the log files created by this Scripted File Based Error Log Publisher. When the `type` value is one of [`third-party-file-based-error`]: The UNIX permissions of the log files created by this Third Party File Based Error Log Publisher. When the `type` value is one of [`file-based-access`]: The UNIX permissions of the log files created by this File Based Access Log Publisher. When the `type` value is one of [`file-based-json-http-operation`]: The UNIX permissions of the log files created by this File Based JSON HTTP Operation Log Publisher.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			"rotation_policy": schema.SetAttribute{
				Description: " When the `type` value is one of [`third-party-file-based-access`]: The rotation policy to use for the Third Party File Based Access Log Publisher . When the `type` value is one of [`operation-timing-access`]: The rotation policy to use for the Operation Timing Access Log Publisher . When the `type` value is one of [`file-based-trace`]: The rotation policy to use for the File Based Trace Log Publisher . When the `type` value is one of [`common-log-file-http-operation`]: The rotation policy to use for the Common Log File HTTP Operation Log Publisher . When the `type` value is one of [`file-based-json-audit`]: The rotation policy to use for the File Based JSON Audit Log Publisher . When the `type` value is one of [`file-based-debug`]: The rotation policy to use for the File Based Debug Log Publisher . When the `type` value is one of [`file-based-error`]: The rotation policy to use for the File Based Error Log Publisher . When the `type` value is one of [`detailed-http-operation`]: The rotation policy to use for the Detailed HTTP Operation Log Publisher . When the `type` value is one of [`json-access`]: The rotation policy to use for the JSON Access Log Publisher . When the `type` value is one of [`debug-access`]: The rotation policy to use for the Debug Access Log Publisher . When the `type` value is one of [`file-based-audit`]: The rotation policy to use for the File Based Audit Log Publisher . When the `type` value is one of [`json-error`]: The rotation policy to use for the JSON Error Log Publisher . When the `type` value is one of [`groovy-scripted-file-based-access`]: The rotation policy to use for the Scripted File Based Access Log Publisher . When the `type` value is one of [`groovy-scripted-file-based-error`]: The rotation policy to use for the Scripted File Based Error Log Publisher . When the `type` value is one of [`third-party-file-based-error`]: The rotation policy to use for the Third Party File Based Error Log Publisher . When the `type` value is one of [`file-based-access`]: The rotation policy to use for the File Based Access Log Publisher . When the `type` value is one of [`file-based-json-http-operation`]: The rotation policy to use for the File Based JSON HTTP Operation Log Publisher .",
				Required:    false,
				Optional:    false,
				Computed:    true,
			...
			"script_argument": schema.SetAttribute{
				Description: " When the `type` value is one of [`groovy-scripted-file-based-access`]: The set of arguments used to customize the behavior for the Scripted File Based Access Log Publisher. Each configuration property should be given in the form 'name=value'. When the `type` value is one of [`groovy-scripted-file-based-error`]: The set of arguments used to customize the behavior for the Scripted File Based Error Log Publisher. Each configuration property should be given in the form 'name=value'. When the `type` value is one of [`groovy-scripted-access`]: The set of arguments used to customize the behavior for the Scripted Access Log Publisher. Each configuration property should be given in the form 'name=value'. When the `type` value is one of [`groovy-scripted-error`]: The set of arguments used to customize the behavior for the Scripted Error Log Publisher. Each configuration property should be given in the form 'name=value'. When the `type` value is one of [`groovy-scripted-http-operation`]: The set of arguments used to customize the behavior for the Scripted HTTP Operation Log Publisher. Each configuration property should be given in the form 'name=value'.",
				Required:    false,
				Optional:    false,
				Computed:    true,
				ElementType: types.StringType,
			...
			"extension_class": schema.StringAttribute{
				Description: " When the `type` value is one of [`third-party-file-based-access`]: The fully-qualified name of the Java class providing the logic for the Third Party File Based Access Log Publisher. When the `type` value is one of [`third-party-http-operation`]: The fully-qualified name of the Java class providing the logic for the Third Party HTTP Operation Log Publisher. When the `type` value is one of [`third-party-error`]: The fully-qualified name of the Java class providing the logic for the Third Party Error Log Publisher. When the `type` value is one of [`third-party-access`]: The fully-qualified name of the Java class providing the logic for the Third Party Access Log Publisher. When the `type` value is one of [`third-party-file-based-error`]: The fully-qualified name of the Java class providing the logic for the Third Party File Based Error Log Publisher.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			...
			"extension_argument": schema.SetAttribute{
				Description: " When the `type` value is one of [`third-party-file-based-access`]: The set of arguments used to customize the behavior for the Third Party File Based Access Log Publisher. Each configuration property should be given in the form 'name=value'. When the `type` value is one of [`third-party-http-operation`]: The set of arguments used to customize the behavior for the Third Party HTTP Operation Log Publisher. Each configuration property should be given in the form 'name=value'. When the `type` value is one of [`third-party-error`]: The set of arguments used to customize the behavior for the Third Party Error Log Publisher. Each configuration property should be given in the form 'name=value'. When the `type` value is one of [`third-party-access`]: The set of arguments used to customize the behavior for the Third Party Access Log Publisher. Each configuration property should be given in the form 'name=value'. When the `type` value is one of [`third-party-file-based-error`]: The set of arguments used to customize the behavior for the Third Party File Based Error Log Publisher. Each configuration property should be given in the form 'name=value'.",
				Required:    false,
				Optional:    false,
				Computed:    true,
				ElementType: types.StringType,
			...
			"max_string_length": schema.Int64Attribute{
				Description: " When the `type` value is one of [`detailed-http-operation`]: Specifies the maximum length of any individual string that should be logged. If a log message includes a string longer than this number of characters, it will be truncated. A value of zero indicates that no truncation will be used. When the `type` value is one of [`operation-timing-access`, `admin-alert-access`, `file-based-trace`, `syslog-based-access`, `syslog-text-access`, `json-access`, `syslog-json-access`, `console-json-access`, `file-based-access`]: Specifies the maximum number of characters that may be included in any string in a log message before that string is truncated and replaced with a placeholder indicating the number of characters that were omitted. This can help prevent extremely long log messages from being written.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			"generify_message_strings_when_possible": schema.BoolAttribute{
				Description: " When the `type` value is one of [`console-json-error`, `syslog-text-error`, `file-based-error`, `json-error`, `syslog-json-error`]: Indicates whether to use the generified version of the log message string (which may use placeholders like %s for a string or %d for an integer), rather than the version of the message with those placeholders replaced with specific values that would normally be written to the log. When the `type` value is one of [`admin-alert-access`, `syslog-based-access`, `syslog-text-access`, `json-access`, `syslog-json-access`, `console-json-access`, `file-based-access`]: Indicates whether to use generified version of certain message strings, including diagnostic messages, additional information messages, authentication failure reasons, and disconnect messages. Generified versions of those strings may use placeholders (like %s for a string or %d for an integer) rather than the version of the string with those placeholders replaced with specific values.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			"syslog_facility": schema.StringAttribute{
				Description: " When the `type` value is one of [`syslog-json-audit`]: The syslog facility to use for the messages that are logged by this Syslog JSON Audit Log Publisher. When the `type` value is one of [`syslog-based-error`]: Specifies the syslog facility to use for this Syslog Based Error Log Publisher When the `type` value is one of [`syslog-text-error`]: The syslog facility to use for the messages that are logged by this Syslog Text Error Log Publisher. When the `type` value is one of [`syslog-based-access`]: Specifies the syslog facility to use for this Syslog Based Access Log Publisher When the `type` value is one of [`syslog-text-access`]: The syslog facility to use for the messages that are logged by this Syslog Text Access Log Publisher. When the `type` value is one of [`syslog-json-http-operation`]: The syslog facility to use for the messages that are logged by this Syslog JSON HTTP Operation Log Publisher. When the `type` value is one of [`syslog-json-access`]: The syslog facility to use for the messages that are logged by this Syslog JSON Access Log Publisher. When the `type` value is one of [`syslog-json-error`]: The syslog facility to use for the messages that are logged by this Syslog JSON Error Log Publisher.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			...
			"asynchronous": schema.BoolAttribute{
				Description: " When the `type` value is one of [`syslog-based-error`]: Indicates whether the Syslog Based Error Log Publisher will publish records asynchronously. When the `type` value is one of [`third-party-file-based-access`]: Indicates whether the Third Party File Based Access Log Publisher will publish records asynchronously. When the `type` value is one of [`operation-timing-access`]: Indicates whether the Operation Timing Access Log Publisher will publish records asynchronously. When the `type` value is one of [`admin-alert-access`]: Indicates whether the Admin Alert Access Log Publisher will publish records asynchronously. When the `type` value is one of [`file-based-trace`]: Indicates whether the Writer Based Trace Log Publisher will publish records asynchronously. When the `type` value is one of [`common-log-file-http-operation`]: Indicates whether the Common Log File HTTP Operation Log Publisher will publish records asynchronously. When the `type` value is one of [`file-based-json-audit`]: Indicates whether the File Based JSON Audit Log Publisher will publish records asynchronously. When the `type` value is one of [`file-based-debug`]: Indicates whether the File Based Debug Log Publisher will publish records asynchronously. When the `type` value is one of [`file-based-error`]: Indicates whether the File Based Error Log Publisher will publish records asynchronously. When the `type` value is one of [`detailed-http-operation`]: Indicates whether the Detailed HTTP Operation Log Publisher will publish records asynchronously. When the `type` value is one of [`json-access`]: Indicates whether the JSON Access Log Publisher will publish records asynchronously. When the `type` value is one of [`debug-access`]: Indicates whether the Debug Access Log Publisher will publish records asynchronously. When the `type` value is one of [`file-based-audit`]: Indicates whether the File Based Audit Log Publisher will publish records asynchronously. When the `type` value is one of [`json-error`]: Indicates whether the JSON Error Log Publisher will publish records asynchronously. When the `type` value is one of [`groovy-scripted-file-based-access`]: Indicates whether the Scripted File Based Access Log Publisher will publish records asynchronously. When the `type` value is one of [`groovy-scripted-file-based-error`]: Indicates whether the Scripted File Based Error Log Publisher will publish records asynchronously. When the `type` value is one of [`third-party-file-based-error`]: Indicates whether the Third Party File Based Error Log Publisher will publish records asynchronously. When the `type` value is one of [`file-based-json-http-operation`]: Indicates whether the File Based JSON HTTP Operation Log Publisher will publish records asynchronously. When the `type` value is one of [`syslog-based-access`, `syslog-text-access`, `file-based-access`]: Indicates whether the Writer Based Access Log Publisher will publish records asynchronously.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			...
			"syslog_severity": schema.StringAttribute{
				Description: " When the `type` value is one of [`syslog-json-audit`]: The syslog severity to use for the messages that are logged by this Syslog JSON Audit Log Publisher. When the `type` value is one of [`syslog-text-error`]: The syslog severity to use for the messages that are logged by this Syslog Text Error Log Publisher. If this is not specified, then the severity for each syslog message will be automatically based on the severity for the associated log message. When the `type` value is one of [`syslog-text-access`]: The syslog severity to use for the messages that are logged by this Syslog Text Access Log Publisher. When the `type` value is one of [`syslog-json-http-operation`]: The syslog severity to use for the messages that are logged by this Syslog JSON HTTP Operation Log Publisher. When the `type` value is one of [`syslog-json-access`]: The syslog severity to use for the messages that are logged by this Syslog JSON Access Log Publisher. When the `type` value is one of [`syslog-json-error`]: The syslog severity to use for the messages that are logged by this Syslog JSON Error Log Publisher. If this is not specified, then the severity for each syslog message will be automatically based on the severity for the associated log message.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			...
			"search_entry_criteria": schema.StringAttribute{
				Description: " When the `type` value is one of [`admin-alert-access`]: Specifies a set of search entry criteria that must match the associated search result entry in order for that it to be logged by this Admin Alert Access Log Publisher. When the `type` value is one of [`third-party-file-based-access`, `jdbc-based-access`, `syslog-based-access`, `syslog-text-access`, `json-access`, `debug-access`, `third-party-access`, `groovy-scripted-file-based-access`, `syslog-json-access`, `groovy-scripted-access`, `console-json-access`, `file-based-access`]: Specifies a set of search entry criteria that must match the associated search result entry in order for that it to be logged by this Access Log Publisher.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			"search_reference_criteria": schema.StringAttribute{
				Description: " When the `type` value is one of [`admin-alert-access`]: Specifies a set of search reference criteria that must match the associated search result reference in order for that it to be logged by this Admin Alert Access Log Publisher. When the `type` value is one of [`third-party-file-based-access`, `jdbc-based-access`, `syslog-based-access`, `syslog-text-access`, `json-access`, `debug-access`, `third-party-access`, `groovy-scripted-file-based-access`, `syslog-json-access`, `groovy-scripted-access`, `console-json-access`, `file-based-access`]: Specifies a set of search reference criteria that must match the associated search result reference in order for that it to be logged by this Access Log Publisher.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			"syslog_message_host_name": schema.StringAttribute{
				Description: " When the `type` value is one of [`syslog-json-audit`]: The local host name that will be included in syslog messages that are logged by this Syslog JSON Audit Log Publisher. When the `type` value is one of [`syslog-text-error`]: The local host name that will be included in syslog messages that are logged by this Syslog Text Error Log Publisher. When the `type` value is one of [`syslog-text-access`]: The local host name that will be included in syslog messages that are logged by this Syslog Text Access Log Publisher. When the `type` value is one of [`syslog-json-http-operation`]: The local host name that will be included in syslog messages that are logged by this Syslog JSON HTTP Operation Log Publisher. When the `type` value is one of [`syslog-json-access`]: The local host name that will be included in syslog messages that are logged by this Syslog JSON Access Log Publisher. When the `type` value is one of [`syslog-json-error`]: The local host name that will be included in syslog messages that are logged by this Syslog JSON Error Log Publisher.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			"syslog_message_application_name": schema.StringAttribute{
				Description: " When the `type` value is one of [`syslog-json-audit`]: The application name that will be included in syslog messages that are logged by this Syslog JSON Audit Log Publisher. When the `type` value is one of [`syslog-text-error`]: The application name that will be included in syslog messages that are logged by this Syslog Text Error Log Publisher. When the `type` value is one of [`syslog-text-access`]: The application name that will be included in syslog messages that are logged by this Syslog Text Access Log Publisher. When the `type` value is one of [`syslog-json-http-operation`]: The application name that will be included in syslog messages that are logged by this Syslog JSON HTTP Operation Log Publisher. When the `type` value is one of [`syslog-json-access`]: The application name that will be included in syslog messages that are logged by this Syslog JSON Access Log Publisher. When the `type` value is one of [`syslog-json-error`]: The application name that will be included in syslog messages that are logged by this Syslog JSON Error Log Publisher.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			...
			"write_multi_line_messages": schema.BoolAttribute{
				Description: " When the `type` value is one of [`console-json-error`, `json-access`, `json-error`, `console-json-access`]: Indicates whether the JSON objects should be formatted to span multiple lines with a single element on each line. The multi-line format is potentially more user friendly (if administrators may need to look at the log files), but each message will be larger because of the additional spaces and end-of-line markers. When the `type` value is one of [`syslog-json-audit`, `file-based-json-audit`, `syslog-json-http-operation`, `console-json-audit`, `console-json-http-operation`, `file-based-json-http-operation`]: Indicates whether the JSON objects should use a multi-line representation (with each object field and array value on its own line) that may be easier for administrators to read, but each message will be larger (because of additional spaces and end-of-line markers), and it may be more difficult to consume and parse through some text-oriented tools.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
			...
			"obscure_attribute": schema.SetAttribute{
				Description: " When the `type` value is one of [`debug-access`]: Specifies the names of any attribute types that should have their values obscured if the obscure-sensitive-content property has a value of true. When the `type` value is one of [`syslog-json-audit`, `file-based-json-audit`, `file-based-audit`, `console-json-audit`]: Specifies the names of any attribute types that should have their values obscured in the audit log because they may be considered sensitive.",
				Required:    false,
				Optional:    false,
				Computed:    true,
				ElementType: types.StringType,
			...
			"enabled": schema.BoolAttribute{
				Description: " When the `type` value is one of [`syslog-based-error`]: Indicates whether the Syslog Based Error Log Publisher is enabled for use. When the `type` value is one of [`console-json-error`]: Indicates whether the Console JSON Error Log Publisher is enabled for use. When the `type` value is one of [`syslog-based-access`]: Indicates whether the Syslog Based Access Log Publisher is enabled for use. When the `type` value is one of [`console-json-audit`]: Indicates whether the Console JSON Audit Log Publisher is enabled for use. When the `type` value is one of [`console-json-http-operation`]: Indicates whether the Console JSON HTTP Operation Log Publisher is enabled for use. When the `type` value is one of [`console-json-access`]: Indicates whether the Console JSON Access Log Publisher is enabled for use. When the `type` value is one of [`syslog-json-audit`, `third-party-file-based-access`, `operation-timing-access`, `third-party-http-operation`, `admin-alert-access`, `file-based-trace`, `jdbc-based-error`, `jdbc-based-access`, `common-log-file-http-operation`, `syslog-text-error`, `file-based-json-audit`, `file-based-debug`, `file-based-error`, `third-party-error`, `syslog-text-access`, `detailed-http-operation`, `json-access`, `debug-access`, `syslog-json-http-operation`, `third-party-access`, `file-based-audit`, `json-error`, `groovy-scripted-file-based-access`, `groovy-scripted-file-based-error`, `syslog-json-access`, `groovy-scripted-access`, `third-party-file-based-error`, `file-based-access`, `groovy-scripted-error`, `file-based-json-http-operation`, `syslog-json-error`, `groovy-scripted-http-operation`]: Indicates whether the Log Publisher is enabled for use.",
				Required:    false,
				Optional:    false,
				Computed:    true,
			},
