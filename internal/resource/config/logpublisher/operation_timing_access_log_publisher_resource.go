...
func NewOperationTimingAccessLogPublisherResource() resource.Resource {
...
func (r *operationTimingAccessLogPublisherResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
type operationTimingAccessLogPublisherResourceModel struct {
	...
	schema := schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"rotation_policy": schema.SetAttribute{
				Description: "The rotation policy to use for the Operation Timing Access Log Publisher .",
				Required:    true,
			...
			"retention_policy": schema.SetAttribute{
				Description: "The retention policy to use for the Operation Timing Access Log Publisher .",
				Required:    true,
				ElementType: types.StringType,
			},
...
func addOptionalOperationTimingAccessLogPublisherFields(ctx context.Context, addRequest *client.AddOperationTimingAccessLogPublisherRequest, plan operationTimingAccessLogPublisherResourceModel) error {
	...
	if internaltypes.IsNonEmptyString(plan.MinIncludedOperationProcessingTime) {
		stringVal := plan.MinIncludedOperationProcessingTime.ValueString()
		addRequest.MinIncludedOperationProcessingTime = &stringVal
	}
...
func readOperationTimingAccessLogPublisherResponse(ctx context.Context, r *client.OperationTimingAccessLogPublisherResponse, state *operationTimingAccessLogPublisherResourceModel, expectedValues *operationTimingAccessLogPublisherResourceModel, diagnostics *diag.Diagnostics) {
...
func createOperationTimingAccessLogPublisherOperations(plan operationTimingAccessLogPublisherResourceModel, state operationTimingAccessLogPublisherResourceModel) []client.Operation {
...
func (r *operationTimingAccessLogPublisherResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Failed to add optional properties to add request for Operation Timing Access Log Publisher", err.Error())
		return
	}
	// Log request JSON
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while creating the Operation Timing Access Log Publisher", err, httpResp)
		return
	}
...
func (r *operationTimingAccessLogPublisherResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while deleting the Operation Timing Access Log Publisher", err, httpResp)
		return
	}
}
