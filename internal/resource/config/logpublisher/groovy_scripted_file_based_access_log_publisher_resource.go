...
func NewGroovyScriptedFileBasedAccessLogPublisherResource() resource.Resource {
...
func (r *groovyScriptedFileBasedAccessLogPublisherResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
type groovyScriptedFileBasedAccessLogPublisherResourceModel struct {
	...
	schema := schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"log_file": schema.StringAttribute{
				Description: "The file name to use for the log files generated by the Scripted File Based Access Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.",
				Required:    true,
			},
			"log_file_permissions": schema.StringAttribute{
				Description: "The UNIX permissions of the log files created by this Scripted File Based Access Log Publisher.",
				Optional:    true,
				Computed:    true,
			},
			"rotation_policy": schema.SetAttribute{
				Description: "The rotation policy to use for the Scripted File Based Access Log Publisher .",
				Optional:    true,
				Computed:    true,
			...
			"retention_policy": schema.SetAttribute{
				Description: "The retention policy to use for the Scripted File Based Access Log Publisher .",
				Optional:    true,
				Computed:    true,
				ElementType: types.StringType,
			},
			...
			"asynchronous": schema.BoolAttribute{
				Description: "Indicates whether the Scripted File Based Access Log Publisher will publish records asynchronously.",
				Optional:    true,
				Computed:    true,
			},
...
func addOptionalGroovyScriptedFileBasedAccessLogPublisherFields(ctx context.Context, addRequest *client.AddGroovyScriptedFileBasedAccessLogPublisherRequest, plan groovyScriptedFileBasedAccessLogPublisherResourceModel) error {
...
func readGroovyScriptedFileBasedAccessLogPublisherResponse(ctx context.Context, r *client.GroovyScriptedFileBasedAccessLogPublisherResponse, state *groovyScriptedFileBasedAccessLogPublisherResourceModel, expectedValues *groovyScriptedFileBasedAccessLogPublisherResourceModel, diagnostics *diag.Diagnostics) {
...
func createGroovyScriptedFileBasedAccessLogPublisherOperations(plan groovyScriptedFileBasedAccessLogPublisherResourceModel, state groovyScriptedFileBasedAccessLogPublisherResourceModel) []client.Operation {
...
func (r *groovyScriptedFileBasedAccessLogPublisherResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Failed to add optional properties to add request for Groovy Scripted File Based Access Log Publisher", err.Error())
		return
	}
	// Log request JSON
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while creating the Groovy Scripted File Based Access Log Publisher", err, httpResp)
		return
	}
...
func (r *groovyScriptedFileBasedAccessLogPublisherResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while deleting the Groovy Scripted File Based Access Log Publisher", err, httpResp)
		return
	}
}
