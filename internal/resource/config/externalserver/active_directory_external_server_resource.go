...
func NewActiveDirectoryExternalServerResource() resource.Resource {
...
func (r *activeDirectoryExternalServerResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func readActiveDirectoryExternalServerResponse(ctx context.Context, r *client.ActiveDirectoryExternalServerResponse, state *activeDirectoryExternalServerResourceModel, expectedValues *activeDirectoryExternalServerResourceModel, diagnostics *diag.Diagnostics) {
...
func createActiveDirectoryExternalServerOperations(plan activeDirectoryExternalServerResourceModel, state activeDirectoryExternalServerResourceModel) []client.Operation {
...
func (r *activeDirectoryExternalServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while creating the Active Directory External Server", err, httpResp)
		return
	}
...
func (r *activeDirectoryExternalServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while deleting the Active Directory External Server", err, httpResp)
		return
	}
}
