...
func readAuthorizeServerInstanceResponse(ctx context.Context, r *client.AuthorizeServerInstanceResponse, state *authorizeServerInstanceResourceModel) {
...
func (r *authorizeServerInstanceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	readAuthorizeServerInstanceResponse(ctx, readResponse.AuthorizeServerInstanceResponse, &state)
	...
	if len(ops) > 0 {
		...
		// Read the response
		readAuthorizeServerInstanceResponse(ctx, updateResponse.AuthorizeServerInstanceResponse, &state)
