...
var (
	_ datasource.DataSource              = &accessTokenValidatorsDataSource{}
	_ datasource.DataSourceWithConfigure = &accessTokenValidatorsDataSource{}
)

// Create a Access Token Validators data source
func NewAccessTokenValidatorsDataSource() datasource.DataSource {
	return &accessTokenValidatorsDataSource{}
}

// accessTokenValidatorsDataSource is the datasource implementation.
type accessTokenValidatorsDataSource struct {
	providerConfig internaltypes.ProviderConfiguration
	apiClient      *client.APIClient
}

// Metadata returns the data source type name.
func (r *accessTokenValidatorsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_access_token_validators"
}

// Configure adds the provider configured client to the data source.
func (r *accessTokenValidatorsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
type accessTokenValidatorsDataSourceModel struct {
...
func (r *accessTokenValidatorsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists Access Token Validator objects in the server configuration.",
		Attributes: map[string]schema.Attribute{
			...
			"objects": schema.SetAttribute{
				Description: "Access Token Validator objects found in the configuration",
				Required:    false,
				Optional:    false,
				Computed:    true,
...
func (r *accessTokenValidatorsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	// Get current state
	var state accessTokenValidatorsDataSourceModel
