...
var (
	_ resource.Resource                = &accessLogFieldMappingResource{}
	_ resource.ResourceWithConfigure   = &accessLogFieldMappingResource{}
	_ resource.ResourceWithImportState = &accessLogFieldMappingResource{}
	_ resource.Resource                = &defaultAccessLogFieldMappingResource{}
	_ resource.ResourceWithConfigure   = &defaultAccessLogFieldMappingResource{}
	_ resource.ResourceWithImportState = &defaultAccessLogFieldMappingResource{}
)

// Create a Access Log Field Mapping resource
func NewAccessLogFieldMappingResource() resource.Resource {
	return &accessLogFieldMappingResource{}
}

func NewDefaultAccessLogFieldMappingResource() resource.Resource {
	return &defaultAccessLogFieldMappingResource{}
}

// accessLogFieldMappingResource is the resource implementation.
type accessLogFieldMappingResource struct {
	providerConfig internaltypes.ProviderConfiguration
	apiClient      *client.APIClient
}

// defaultAccessLogFieldMappingResource is the resource implementation.
type defaultAccessLogFieldMappingResource struct {
	providerConfig internaltypes.ProviderConfiguration
	apiClient      *client.APIClient
}

// Metadata returns the resource type name.
func (r *accessLogFieldMappingResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_access_log_field_mapping"
}

func (r *defaultAccessLogFieldMappingResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_default_access_log_field_mapping"
}

// Configure adds the provider configured client to the resource.
func (r *accessLogFieldMappingResource) Configure(_ context.Context, req resource.ConfigureRequest, _ *resource.ConfigureResponse) {
...
func (r *defaultAccessLogFieldMappingResource) Configure(_ context.Context, req resource.ConfigureRequest, _ *resource.ConfigureResponse) {
	if req.ProviderData == nil {
		return
	}
...
type accessLogFieldMappingResourceModel struct {
...
func (r *accessLogFieldMappingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	accessLogFieldMappingSchema(ctx, req, resp, false)
}

func (r *defaultAccessLogFieldMappingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	accessLogFieldMappingSchema(ctx, req, resp, true)
}

func accessLogFieldMappingSchema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse, setOptionalToComputed bool) {
	schema := schema.Schema{
		Description: "Manages a Access Log Field Mapping.",
...
func addOptionalAccessLogFieldMappingFields(ctx context.Context, addRequest *client.AddAccessLogFieldMappingRequest, plan accessLogFieldMappingResourceModel) {
...
func readAccessLogFieldMappingResponse(ctx context.Context, r *client.AccessLogFieldMappingResponse, state *accessLogFieldMappingResourceModel, expectedValues *accessLogFieldMappingResourceModel, diagnostics *diag.Diagnostics) {
...
func createAccessLogFieldMappingOperations(plan accessLogFieldMappingResourceModel, state accessLogFieldMappingResourceModel) []client.Operation {
...
func (r *accessLogFieldMappingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	// Retrieve values from plan
	var plan accessLogFieldMappingResourceModel
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while creating the Access Log Field Mapping", err, httpResp)
		return
	}
	...
	var state accessLogFieldMappingResourceModel
...
func (r *defaultAccessLogFieldMappingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	// Retrieve values from plan
	var plan accessLogFieldMappingResourceModel
	diags := req.Plan.Get(ctx, &plan)
	resp.Diagnostics.Append(diags...)
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while getting the Access Log Field Mapping", err, httpResp)
		return
	}
	...
	ops := createAccessLogFieldMappingOperations(plan, state)
	if len(ops) > 0 {
		...
		if err != nil {
			config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while updating the Access Log Field Mapping", err, httpResp)
			return
		}
...
func (r *accessLogFieldMappingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	readAccessLogFieldMapping(ctx, req, resp, r.apiClient, r.providerConfig)
}

func (r *defaultAccessLogFieldMappingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	readAccessLogFieldMapping(ctx, req, resp, r.apiClient, r.providerConfig)
}

func readAccessLogFieldMapping(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse, apiClient *client.APIClient, providerConfig internaltypes.ProviderConfiguration) {
	// Get current state
	var state accessLogFieldMappingResourceModel
...
// Update a resource
func (r *accessLogFieldMappingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	updateAccessLogFieldMapping(ctx, req, resp, r.apiClient, r.providerConfig)
}

func (r *defaultAccessLogFieldMappingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	updateAccessLogFieldMapping(ctx, req, resp, r.apiClient, r.providerConfig)
}

func updateAccessLogFieldMapping(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse, apiClient *client.APIClient, providerConfig internaltypes.ProviderConfiguration) {
	// Retrieve values from plan
	var plan accessLogFieldMappingResourceModel
	diags := req.Plan.Get(ctx, &plan)
	resp.Diagnostics.Append(diags...)
...
func (r *defaultAccessLogFieldMappingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	// No implementation necessary
}

func (r *accessLogFieldMappingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		config.ReportHttpError(ctx, &resp.Diagnostics, "An error occurred while deleting the Access Log Field Mapping", err, httpResp)
		return
	}
}

func (r *accessLogFieldMappingResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	importAccessLogFieldMapping(ctx, req, resp)
}

func (r *defaultAccessLogFieldMappingResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	importAccessLogFieldMapping(ctx, req, resp)
}

func importAccessLogFieldMapping(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
