...
func (p *pingdirectoryProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		ldapcorrelationattributepair.NewLdapCorrelationAttributePairsDataSource,
		...
		localdbcompositeindex.NewLocalDbCompositeIndexesDataSource,
		localdbindex.NewLocalDbIndexDataSource,
		localdbindex.NewLocalDbIndexesDataSource,
		localdbvlvindex.NewLocalDbVlvIndexDataSource,
		localdbvlvindex.NewLocalDbVlvIndexesDataSource,
		location.NewLocationDataSource,
		location.NewLocationsDataSource,
		logfieldbehavior.NewLogFieldBehaviorDataSource,
		logfieldbehavior.NewLogFieldBehaviorsDataSource,
		logfieldmapping.NewLogFieldMappingDataSource,
		logfieldmapping.NewLogFieldMappingsDataSource,
		logfieldsyntax.NewLogFieldSyntaxDataSource,
		logfieldsyntax.NewLogFieldSyntaxesDataSource,
		logfilerotationlistener.NewLogFileRotationListenerDataSource,
		logfilerotationlistener.NewLogFileRotationListenersDataSource,
		logpublisher.NewLogPublisherDataSource,
		logpublisher.NewLogPublishersDataSource,
		logretentionpolicy.NewLogRetentionPolicyDataSource,
		logretentionpolicy.NewLogRetentionPoliciesDataSource,
		logrotationpolicy.NewLogRotationPolicyDataSource,
		logrotationpolicy.NewLogRotationPoliciesDataSource,
		macsecretkey.NewMacSecretKeyDataSource,
		macsecretkey.NewMacSecretKeysDataSource,
		matchingrule.NewMatchingRuleDataSource,
		matchingrule.NewMatchingRulesDataSource,
		monitoringendpoint.NewMonitoringEndpointDataSource,
		monitoringendpoint.NewMonitoringEndpointsDataSource,
		monitorprovider.NewMonitorProviderDataSource,
		monitorprovider.NewMonitorProvidersDataSource,
		notificationmanager.NewNotificationManagerDataSource,
		notificationmanager.NewNotificationManagersDataSource,
		oauthtokenhandler.NewOauthTokenHandlerDataSource,
		oauthtokenhandler.NewOauthTokenHandlersDataSource,
		obscuredvalue.NewObscuredValueDataSource,
		obscuredvalue.NewObscuredValuesDataSource,
		otpdeliverymechanism.NewOtpDeliveryMechanismDataSource,
		otpdeliverymechanism.NewOtpDeliveryMechanismsDataSource,
		passphraseprovider.NewPassphraseProviderDataSource,
		passphraseprovider.NewPassphraseProvidersDataSource,
		passthroughauthenticationhandler.NewPassThroughAuthenticationHandlerDataSource,
		passthroughauthenticationhandler.NewPassThroughAuthenticationHandlersDataSource,
		passwordgenerator.NewPasswordGeneratorDataSource,
		passwordgenerator.NewPasswordGeneratorsDataSource,
		passwordpolicy.NewPasswordPolicyDataSource,
		passwordpolicy.NewPasswordPoliciesDataSource,
		passwordstoragescheme.NewPasswordStorageSchemeDataSource,
		passwordstoragescheme.NewPasswordStorageSchemesDataSource,
		passwordvalidator.NewPasswordValidatorDataSource,
		passwordvalidator.NewPasswordValidatorsDataSource,
		...
		recurringtask.NewRecurringTasksDataSource,
		recurringtaskchain.NewRecurringTaskChainDataSource,
		recurringtaskchain.NewRecurringTaskChainsDataSource,
		replicationassurancepolicy.NewReplicationAssurancePolicyDataSource,
		replicationassurancepolicy.NewReplicationAssurancePoliciesDataSource,
		...
		restresourcetype.NewRestResourceTypesDataSource,
		resultcodemap.NewResultCodeMapDataSource,
		resultcodemap.NewResultCodeMapsDataSource,
		resultcriteria.NewResultCriteriaDataSource,
		resultcriteria.NewResultCriteriaListDataSource,
		rootdn.NewRootDnDataSource,
		rootdnuser.NewRootDnUserDataSource,
		rootdnuser.NewRootDnUsersDataSource,
		rootdsebackend.NewRootDseBackendDataSource,
		saslmechanismhandler.NewSaslMechanismHandlerDataSource,
		saslmechanismhandler.NewSaslMechanismHandlersDataSource,
		scimattribute.NewScimAttributeDataSource,
		scimattribute.NewScimAttributesDataSource,
		scimattributemapping.NewScimAttributeMappingDataSource,
		scimattributemapping.NewScimAttributeMappingsDataSource,
		scimresourcetype.NewScimResourceTypeDataSource,
		scimresourcetype.NewScimResourceTypesDataSource,
		scimschema.NewScimSchemaDataSource,
		scimschema.NewScimSchemasDataSource,
		scimsubattribute.NewScimSubattributeDataSource,
		scimsubattribute.NewScimSubattributesDataSource,
		searchentrycriteria.NewSearchEntryCriteriaDataSource,
		searchentrycriteria.NewSearchEntryCriteriaListDataSource,
		searchreferencecriteria.NewSearchReferenceCriteriaDataSource,
		searchreferencecriteria.NewSearchReferenceCriteriaListDataSource,
		sensitiveattribute.NewSensitiveAttributeDataSource,
		sensitiveattribute.NewSensitiveAttributesDataSource,
		servergroup.NewServerGroupDataSource,
		servergroup.NewServerGroupsDataSource,
		serverinstance.NewServerInstanceDataSource,
		serverinstance.NewServerInstancesDataSource,
		serverinstancelistener.NewServerInstanceListenerDataSource,
		serverinstancelistener.NewServerInstanceListenersDataSource,
		softdeletepolicy.NewSoftDeletePolicyDataSource,
		softdeletepolicy.NewSoftDeletePoliciesDataSource,
		synchronizationprovider.NewSynchronizationProviderDataSource,
		synchronizationprovider.NewSynchronizationProvidersDataSource,
		tokenclaimvalidation.NewTokenClaimValidationDataSource,
		tokenclaimvalidation.NewTokenClaimValidationsDataSource,
		topologyadminuser.NewTopologyAdminUserDataSource,
		topologyadminuser.NewTopologyAdminUsersDataSource,
		trustedcertificate.NewTrustedCertificateDataSource,
		trustedcertificate.NewTrustedCertificatesDataSource,
		trustmanagerprovider.NewTrustManagerProviderDataSource,
		trustmanagerprovider.NewTrustManagerProvidersDataSource,
		uncachedattributecriteria.NewUncachedAttributeCriteriaDataSource,
		uncachedattributecriteria.NewUncachedAttributeCriteriaListDataSource,
		uncachedentrycriteria.NewUncachedEntryCriteriaDataSource,
		uncachedentrycriteria.NewUncachedEntryCriteriaListDataSource,
		vaultauthenticationmethod.NewVaultAuthenticationMethodDataSource,
		vaultauthenticationmethod.NewVaultAuthenticationMethodsDataSource,
		velocitycontextprovider.NewVelocityContextProviderDataSource,
		velocitycontextprovider.NewVelocityContextProvidersDataSource,
		velocitytemplateloader.NewVelocityTemplateLoaderDataSource,
		velocitytemplateloader.NewVelocityTemplateLoadersDataSource,
		virtualattribute.NewVirtualAttributeDataSource,
		virtualattribute.NewVirtualAttributesDataSource,
		webapplicationextension.NewWebApplicationExtensionDataSource,
		webapplicationextension.NewWebApplicationExtensionsDataSource,
