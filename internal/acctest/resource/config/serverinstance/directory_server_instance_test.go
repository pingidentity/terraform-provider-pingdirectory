		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fmt.Sprintf("pingdirectory_directory_server_instance.%s", resourceName), "preferred_security", "ssl"),
					resource.TestCheckResourceAttr(fmt.Sprintf("pingdirectory_directory_server_instance.%s", resourceName), "ldap_port", "1389"),
				),
			},
			{
