...
page_title: "pingdirectory_default_console_json_http_operation_log_publisher Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Console Json Http Operation Log Publisher.
---

# pingdirectory_default_console_json_http_operation_log_publisher (Resource)
