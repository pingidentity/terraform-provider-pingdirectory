...
page_title: "pingdirectory_nokia_ds_external_server Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Nokia Ds External Server.
---

# pingdirectory_nokia_ds_external_server (Resource)
...
```shell
# "nokiaDsExternalServerId" should be the id of the Nokia Ds External Server to be imported
terraform import pingdirectory_nokia_ds_external_server.myNokiaDsExternalServer nokiaDsExternalServerId
```
