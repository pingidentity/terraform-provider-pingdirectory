...
# pingdirectory_default_console_json_access_log_publisher (Resource)
...
- `output_location` (String) Specifies the output stream to which JSON-formatted access log messages should be written.
