---
page_title: "pingdirectory_default_high_throughput_work_queue Resource - terraform-provider-pingdirectory"
subcategory: "Work Queue"
description: |-
  Manages a High Throughput Work Queue.
---

# pingdirectory_default_high_throughput_work_queue (Resource)
...
terraform import pingdirectory_default_high_throughput_work_queue.myHighThroughputWorkQueue id
```
