...
page_title: "pingdirectory_default_ping_identity_ds_external_server Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Ping Identity Ds External Server.
---

# pingdirectory_default_ping_identity_ds_external_server (Resource)
