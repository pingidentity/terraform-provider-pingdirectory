...
page_title: "pingdirectory_default_dn_join_virtual_attribute Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Dn Join Virtual Attribute.
---

# pingdirectory_default_dn_join_virtual_attribute (Resource)
...
- `join_dn_attribute` (String) The attribute whose values are the DNs of the entries to be joined with the search result entry.
