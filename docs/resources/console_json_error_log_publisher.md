...
page_title: "pingdirectory_console_json_error_log_publisher Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Console Json Error Log Publisher.
---

# pingdirectory_console_json_error_log_publisher (Resource)
