---
page_title: "pingdirectory_default_recurring_task Resource - terraform-provider-pingdirectory"
subcategory: "Recurring Task"
description: |-
  Manages a Recurring Task.
---

# pingdirectory_default_recurring_task (Resource)
...
- `encrypt` (Boolean) When the `type` attribute is set to:
