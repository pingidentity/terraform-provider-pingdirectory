...
page_title: "pingdirectory_member_of_server_group_virtual_attribute Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Member Of Server Group Virtual Attribute.
---

# pingdirectory_member_of_server_group_virtual_attribute (Resource)
