---
page_title: "pingdirectory_numeric_gauge_data_source Resource - terraform-provider-pingdirectory"
subcategory: "Gauge Data Source"
description: |-
  Manages a Numeric Gauge Data Source.
---

# pingdirectory_numeric_gauge_data_source (Resource)
...
```shell
# "numericGaugeDataSourceId" should be the id of the Numeric Gauge Data Source to be imported
terraform import pingdirectory_numeric_gauge_data_source.myNumericGaugeDataSource numericGaugeDataSourceId
```
