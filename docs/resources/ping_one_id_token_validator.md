---
page_title: "pingdirectory_ping_one_id_token_validator Resource - terraform-provider-pingdirectory"
subcategory: "Id Token Validator"
description: |-
  Manages a Ping One Id Token Validator.
---

# pingdirectory_ping_one_id_token_validator (Resource)
...
```shell
# "pingOneIdTokenValidatorId" should be the id of the Ping One Id Token Validator to be imported
terraform import pingdirectory_ping_one_id_token_validator.myPingOneIdTokenValidator pingOneIdTokenValidatorId
```
