---
page_title: "pingdirectory_text_access_log_field_behavior Resource - terraform-provider-pingdirectory"
subcategory: "Log Field Behavior"
description: |-
  Manages a Text Access Log Field Behavior.
---

# pingdirectory_text_access_log_field_behavior (Resource)
...
```shell
# "textAccessLogFieldBehaviorId" should be the id of the Text Access Log Field Behavior to be imported
terraform import pingdirectory_text_access_log_field_behavior.myTextAccessLogFieldBehavior textAccessLogFieldBehaviorId
```
