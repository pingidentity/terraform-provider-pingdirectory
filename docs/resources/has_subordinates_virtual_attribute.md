...
page_title: "pingdirectory_has_subordinates_virtual_attribute Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Has Subordinates Virtual Attribute.
---

# pingdirectory_has_subordinates_virtual_attribute (Resource)
