...
page_title: "pingdirectory_console_json_http_operation_log_publisher Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Console Json Http Operation Log Publisher.
---

# pingdirectory_console_json_http_operation_log_publisher (Resource)
...
- `output_location` (String) Specifies the output stream to which JSON-formatted HTTP operation log messages should be written.
