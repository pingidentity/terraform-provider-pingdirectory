...
page_title: "pingdirectory_default_nokia_proxy_server_external_server Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Nokia Proxy Server External Server.
---

# pingdirectory_default_nokia_proxy_server_external_server (Resource)
