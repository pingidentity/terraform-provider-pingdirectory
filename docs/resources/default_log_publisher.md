...
- `http_event` (Set of String) Supported in PingDirectory product version 10.3.0.0+. Specifies the HTTP event types to include in the log.
...
- `suppress_virtual_attributes_in_delete_records` (Boolean) Supported in PingDirectory product version 10.3.0.0+. Indicates whether to suppress virtual attributes from delete audit log messages.
