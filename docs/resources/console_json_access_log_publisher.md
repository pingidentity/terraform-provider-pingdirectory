...
page_title: "pingdirectory_console_json_access_log_publisher Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Console Json Access Log Publisher.
---

# pingdirectory_console_json_access_log_publisher (Resource)
