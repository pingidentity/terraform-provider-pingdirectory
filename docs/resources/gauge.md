...
- `type` (String) The type of gauge resource. Options are `numeric` and `indicator`
...
- `critical_value` (String) A value that is used to determine whether the current monitored value indicates this gauge's severity should be 'critical'.
...
- `major_value` (String) A value that is used to determine whether the current monitored value indicates this gauge's severity should be 'major'.
...
- `minor_value` (String) A value that is used to determine whether the current monitored value indicates this gauge's severity should be 'minor'.
...
- `warning_value` (String) A value that is used to determine whether the current monitored value indicates this gauge's severity should be 'warning'.
...
```shell
# "gaugeId" should be the id of the Gauge to be imported
