...
page_title: "pingdirectory_num_subordinates_virtual_attribute Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Num Subordinates Virtual Attribute.
---

# pingdirectory_num_subordinates_virtual_attribute (Resource)
