...
page_title: "pingdirectory_active_directory_external_server Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Active Directory External Server.
---

# pingdirectory_active_directory_external_server (Resource)
