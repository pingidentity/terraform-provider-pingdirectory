---
page_title: "pingdirectory_default_bit_string_attribute_syntax Resource - terraform-provider-pingdirectory"
subcategory: "Attribute Syntax"
description: |-
  Manages a Bit String Attribute Syntax.
---

# pingdirectory_default_bit_string_attribute_syntax (Resource)
...
```shell
# "bitStringAttributeSyntaxId" should be the id of the Bit String Attribute Syntax to be imported
terraform import pingdirectory_default_bit_string_attribute_syntax.myBitStringAttributeSyntax bitStringAttributeSyntaxId
```
