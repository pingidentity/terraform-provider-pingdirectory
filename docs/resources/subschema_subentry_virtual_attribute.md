...
page_title: "pingdirectory_subschema_subentry_virtual_attribute Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Subschema Subentry Virtual Attribute.
---

# pingdirectory_subschema_subentry_virtual_attribute (Resource)
