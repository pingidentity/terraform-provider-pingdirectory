---
page_title: "pingdirectory_statsd_monitoring_endpoint Resource - terraform-provider-pingdirectory"
subcategory: "Monitoring Endpoint"
description: |-
  Manages a Statsd Monitoring Endpoint.
---

# pingdirectory_statsd_monitoring_endpoint (Resource)
...
```shell
# "statsdMonitoringEndpointId" should be the id of the Statsd Monitoring Endpoint to be imported
terraform import pingdirectory_statsd_monitoring_endpoint.myStatsdMonitoringEndpoint statsdMonitoringEndpointId
```
