---
page_title: "pingdirectory_fifo_entry_cache Resource - terraform-provider-pingdirectory"
subcategory: "Entry Cache"
description: |-
  Manages a Fifo Entry Cache.
---

# pingdirectory_fifo_entry_cache (Resource)
...
```shell
# "fifoEntryCacheId" should be the id of the Fifo Entry Cache to be imported
terraform import pingdirectory_fifo_entry_cache.myFifoEntryCache fifoEntryCacheId
```
