...
page_title: "pingdirectory_delegated_admin_http_servlet_extension Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Delegated Admin Http Servlet Extension.
---

# pingdirectory_delegated_admin_http_servlet_extension (Resource)
