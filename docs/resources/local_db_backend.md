...
# pingdirectory_local_db_backend (Resource)
...
- `je_property` (Set of String) Specifies the database and environment properties for the Berkeley DB Java Edition database serving the data for this backend.
