...
page_title: "pingdirectory_default_file_based_json_audit_log_publisher Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a File Based Json Audit Log Publisher.
---

# pingdirectory_default_file_based_json_audit_log_publisher (Resource)
