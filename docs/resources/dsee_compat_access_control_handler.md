...
page_title: "pingdirectory_dsee_compat_access_control_handler Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Dsee Compat Access Control Handler.
---

# pingdirectory_dsee_compat_access_control_handler (Resource)
...
terraform import pingdirectory_dsee_compat_access_control_handler dseeCompatAccessControlHandlerName
```
