---
page_title: "pingdirectory_ldap_mapping_scim_resource_type Resource - terraform-provider-pingdirectory"
subcategory: "Scim Resource Type"
description: |-
  Manages a Ldap Mapping Scim Resource Type.
---

# pingdirectory_ldap_mapping_scim_resource_type (Resource)
...
```shell
# "ldapMappingScimResourceTypeId" should be the id of the Ldap Mapping Scim Resource Type to be imported
terraform import pingdirectory_ldap_mapping_scim_resource_type.myLdapMappingScimResourceType ldapMappingScimResourceTypeId
```
