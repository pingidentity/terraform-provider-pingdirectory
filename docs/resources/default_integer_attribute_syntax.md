---
page_title: "pingdirectory_default_integer_attribute_syntax Resource - terraform-provider-pingdirectory"
subcategory: "Attribute Syntax"
description: |-
  Manages a Integer Attribute Syntax.
---

# pingdirectory_default_integer_attribute_syntax (Resource)
...
```shell
# "integerAttributeSyntaxId" should be the id of the Integer Attribute Syntax to be imported
terraform import pingdirectory_default_integer_attribute_syntax.myIntegerAttributeSyntax integerAttributeSyntaxId
```
