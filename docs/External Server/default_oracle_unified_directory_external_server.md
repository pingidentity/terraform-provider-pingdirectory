...
page_title: "pingdirectory_default_oracle_unified_directory_external_server Resource - terraform-provider-pingdirectory"
subcategory: ""
description: |-
  Manages a Oracle Unified Directory External Server.
---

# pingdirectory_default_oracle_unified_directory_external_server (Resource)
